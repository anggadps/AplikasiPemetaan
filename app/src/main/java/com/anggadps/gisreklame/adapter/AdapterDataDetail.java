...
public class AdapterDataDetail extends RecyclerView.Adapter<AdapterDataDetail.HolderData> {
    ...
    public AdapterDataDetail(Context ctx, List<DataModel>mList)
    {
        this.ctx = ctx;
        this.mList = mList;
    }
    ...
    public HolderData onCreateViewHolder(ViewGroup parent , int viewType) {
        View layout = LayoutInflater.from(parent.getContext()).inflate(R.layout.layoutlistdetail,parent,false);
        ...
        public HolderData (View v)
        {
            ...
            v.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    //TAMPIL GAMBAR
                   // Glide.with(ctx)
                     //       .load(goInput.putExtra("gambar", dm.getGambar()))
                       //     .asBitmap()
                         //   .fitCenter()
                           // .into(gambar);
